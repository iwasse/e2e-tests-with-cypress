...
- [git](https://git-scm.com/downloads) (I've used version `2.42.0` while writing this doc)
- [Node.js](https://nodejs.org/en/) (I've used version `v18.17.0` while writing this doc)
- npm (I've used version `9.6.7` while writing this doc)
